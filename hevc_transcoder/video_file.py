...
class VideoFile:
    ...
    def __init__(self, basedir, source_relpath):
        ...
        self.key = {"todo": "TODO/" + source_relpath, "done": "DONE/" + target_relpath}
    ...
    def upload_for_processing(self):
        ...
        s3.upload_file(Filename=self.source, Bucket=bucket, Key=self.key["todo"])
        self.uploaded = True
    ...
    def download_processed(self):
        ...
        s3.download_file(Bucket=bucket, Key=self.key["done"], Filename=self.target)
